...
public final class Constants
{
    ...
    public static final String[][] LOCAL_CATALOGS = {
            { "opac-de-916", "OPAC Ostfalia", "Bibliothek Ostfalia" }
    };
    ...
    public static String getSearchUrl(String search, int start, int numRecords, boolean isLocalSearch, int localCatalogIndex)
    {
        ...
        url += "?version=2.0&operation=searchRetrieve&query=pica.all=" + search;
        url += "+or+pica.tmb=" + search;
        // url += "+not+(pica.mak=ac*+or+pica.mak=bc*+or+pica.mak=ec*+or+pica.mak=gc*+or+pica.mak=kc*+or+pica.mak=mc*+or+pica.mak=oc*+or+pica.mak=sc*)";
     ...
     * Returns the address to location information in JSON format
     */
    public static String getLocationUrlKey(int localCatalogIndex)
    {
        return  "http://uri.gbv.de/organization/isil/" + Constants.BIB_CODES[localCatalogIndex];
    }
    ...
    /**
     * An URL to a RSS news feed
     */
    public static final String NEWS_URL = ""; // "http://www.ostfalia.de/cms/de/bib/Bibliotheksnews/";

    /**
     * An URL to a homepage
     */
    public static final String[] HOMEPAGE_URLS = {"https://www.ostfalia.de/cms/de/bib/"
    };
